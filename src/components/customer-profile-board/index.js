...
export default angular
	.module('ccms.components.customerProfileBoard', ['ccms.components.bindHtml', CustomerProfileHeader, CustomerProfileViewMode, CustomerProfileListMode, CustomerDefinedAttributeEditor])
